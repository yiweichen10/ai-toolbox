...
- 当前状态：159个工具（127个已发布，32个待发布）→ 2026-04-27
...
- **git add 安全策略**（2026-04-14修复）：publish_new_tools.py 的 `git add -A` 已改为 `git add -u` + 明确路径，防止误提交临时文件。此前已发生4次误提交事件
...
- generate_tools.py 工具名列表已扩充至150+个（2026-06-12更新：+90个新工具名，覆盖Agent框架、RAG/向量DB、垂域SaaS、AI硬件等8大类）
